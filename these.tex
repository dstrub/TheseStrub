...
\rowcolor[HTML]{E9E9EF} 
\multicolumn{1}{l|}{\cellcolor[HTML]{E9E9EF} $v_i$}  		&Is  the $i^{th}$ vertice of the polygon $P$	 & Section	:\ref{sec:AGPdef}  & 	Only the Section \ref{sec:AGP}	   						  \tabularnewline \hline \hline
...
\toprule
 ...
 \rowcolor[HTML]{E9E9EF} 
\multicolumn{1}{l|}{\cellcolor[HTML]{E9E9EF} $m$}  	& Is equal to the number of points in the grid $G$ & Section	:\ref{sec:Grid}  & 	All	    \tabularnewline \hline \hline
