...
\multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}$f$}  &	the focal lens &	Section	:\ref{sec:CamerasDefinition}    &	Only the Section \ref{sec:NmbWaypoint}		  \tabularnewline \hline
    \rowcolor[HTML]{E9E9EF} 
\multicolumn{1}{l|}{\cellcolor[HTML]{E9E9EF}$!$}  &	one solution of waypoints set  &	Section	:\ref{sec:NmbWaypoint}     &	Only the Section \ref{sec:NmbWaypoint}					  \tabularnewline \hline
   \rowcolor[HTML]{FFFFFF} 
\multicolumn{1}{l|}{\cellcolor[HTML]{FFFFFF}$!$}  &	cost function     &	Section	:\ref{sec:NmbWaypoint}    &	Only the Section \ref{sec:NmbWaypoint}		  \tabularnewline \hline
