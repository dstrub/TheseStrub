...
\begin{tabular}{|l|l|l|l|l|l|}
  ...
  \Emph{Room U} &  \textbf{120x80} & 12 &20 \\ \hline
...
It appear the big room in L shape as the Figure \figref{subfig:r5} is the most suitable to test the hybridization.  % (POURQUOI ???).
...
\end{mfigures}
	...
	Thanks to the results obtained (see  Section \ref{sec:hybridGAPSO}) an  set of experiments is made using a slightly bigger size than the big room (in Figure \figref{fig:Rooms_shapes}). The environment of these experiments try to be more realistic, consequently the room is designed with more obstacles. 
