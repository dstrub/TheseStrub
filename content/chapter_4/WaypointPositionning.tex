...
For this  experiment, the area proposed here is the biggest never tested yet here. The grid is composed by almost 1 million of points with more than 616 thousand of points to cover (number of white pixel). The number of waypoints to cover this vast area has  been increased to reach  the  110 waypoints. The number of waypoints      to  place and optimize, is the much more important compared to the literature for example, in \citep{8*zhou2011,33*reddy2012}.
