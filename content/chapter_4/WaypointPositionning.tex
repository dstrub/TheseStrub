...
The methodologies used is to consider each individual or also called particles as a solution of the problems and optimize its at each iteration. To do that each solution must be comparable and quantifiable. At each iteration each particles have to be tested by a cost function in order to discriminate the best particles of the swarm.
