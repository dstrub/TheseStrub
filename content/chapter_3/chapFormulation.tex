...
Among the constraints listed different priority and restriction exist. Indeed the constraint can be considered in 2 sub-class. 
 ...
 The soft constraints are some constraints  have to be minimized. If a small constraint is not fully respected  the solution can still be considered as acceptable and this small amount of error does not  affect so much the final ansewer. 
 
 the soft constraint leave the posibility during the optimization to do some mistake in order to learn about it  
