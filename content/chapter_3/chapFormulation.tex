...
To evaluate the coverage of a set of cameras is essential to can estimate the camera projection of each,    as detailed in the section \ref{sec:CamerasDefinition}. The area cover by the cameras are noted as in equation \ref{eq:PciK} (where $Pc\in G$).
