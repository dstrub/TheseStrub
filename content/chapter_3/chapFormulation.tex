...
Finally the too low sampling frequency instead to win computation time, may affect the quality of coverage  the estimation and consequently the answer. But, as explained the impact of a too high frequency in the solution have also some consequence as is summarize in the table \ref.... \\
...
%\subparagraph{Disadvantage of the  high sampling frequency.}
////////////progressive sampling/////
In Zhao et al [22*] the points $g_i$ of the grid $G$ are called targets and have to be covered. Despite a slow density of target at the beginning  the number of target increase slowly to have a better density and refine result. In[22*] the increasing frequency of target is applied to refine the solution and add more cameras  at eacg step of the optimisation for a better coverage.  \\
