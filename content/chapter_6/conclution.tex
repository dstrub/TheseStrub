...
The solution proposed must be adapted on UAVs for smart agriculture and precision agriculture. The advantage and flexibility provided by our algorithm can be useful for it. In this case the next step is to work on the image acquisition from RGB or multi-spectral images, which can precisely characterize the fields and segment of the zone depending the vegetation requirement. % despite some small hole in the path plan.
