...
The WSN refer commonly to sensor or actuator  with no restriction in the view angle, it is considering to have a $360^\circ$ of field of view  as in \cite{200*kulkarni2011, 174*zhang2016,150*chakrabarty2002} (as illustrate in the Figure \ref{fig:WsnSensor1}) and in some case a spherical as example in \cite{175*medhi2013,59*wang2008}.  

Each sensors have a position $x$ in the area and a power. From the sensor power the radius $r$ of the circle is deduced from $x$ as center (show \ref{fig:WsnSensor1}). This circle give the area cover by a sensor in the simplest case. 
