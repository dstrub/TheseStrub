...
The previous methods must be  even more constrained when used with perspective camera due to the limited field of view.  
...
One of the parts is a local crossover and the other is a more classical crossover.  The local crossover (called Proximity Based Crosover in  Topcuoglu et al. \cite{101*topcuoglu2009}) is a crossover modified to have just a small amount of genome modified in order to have a crossover with a slightly modification and consequently  a proximity between the solution and this offspring. 
