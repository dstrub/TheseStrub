...
Some solution are existing to solve the WRP. The solution to solve it are applicable only if the polygon is simple. A polygon is considered as simple, when the boundary of it are composed of continue straight lines that do not intersect between her. To complete this definition it is important to precise the simple polygon does not have hole (see Figure \figref{fig:simplePoly}). 
 \begin{mfigures}[!]
...
%119* 214* 215* 146*  144* 164* 167* 190*=cellule decomposition \\ 
 ...
 \paragraph{Sweep} 
	...
	To summarize the sweep as to be correctly chosen. To choose the appropriate sweep the following ellement has to be taking in account:
	\begin{itemize}
