...
The AGP then WRP has greatly impacted the vision and the problem design of coverage and coverage path planning. Especially the CPP by splitting the problem into two sub-problem. 
