...
\textbf{"How to calculate a shortest route contained inside a polygon such that any point inside this polygon is visible from at least one point on the route?"}.  
